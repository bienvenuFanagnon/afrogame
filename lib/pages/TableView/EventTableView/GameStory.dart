...
class GameStoryPage extends StatefulWidget {
  final String sousCategorie;
  GameStoryPage(this.sousCategorie);
  @override
  _GameStoryPageState createState() => _GameStoryPageState();
}

class _GameStoryPageState extends State<GameStoryPage> {
  ...
  Future<void> _loadInitialData() async {
    await authController.getEventDatasImagesByCatAndTypeJeu(100,widget.sousCategorie,"GAMESTORY").listen((data) {
                ...
                SliverList(
                  delegate: SliverChildBuilderDelegate(
                      ...
                      return GestureDetector(
                          ...
                          child: _buildEventCard(event, size));
                    },
