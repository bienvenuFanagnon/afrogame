...
class _NewEventPageState extends State<NewEventPage> {
  ...
  final Map<String, List<String>> cities = {
    "Togo": ["Lomé", "Kara","Vogan","Aneho","Tsevie","Tabligbo"],
    "Ghana": ["Accra", "Kumasi"],
        ...
        await authController.getUsers().then((users) async {
          if(users.isNotEmpty){
            ...
            await authController.sendNotification(
                userIds: listUserId,
                smallImage:urlNotif.isNotEmpty?urlNotif: authController.userLogged.urlImage!,
                ...
                message: "➡️🔥 ${_titleController.text}",
                type_notif: "Annonce",
